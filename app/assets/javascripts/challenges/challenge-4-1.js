jQuery(function($) {
  question("Finish the buildSeats function using the $.each utility.  buildSeats should return a string, with an <li> tag for each seat. Make sure you refer to the HTML and JSON below when creating the seats.");
  ...
  //   var seat_html = "";
  //   
  //   // seats is an array of 'seat' objects
  //   // build up the seat_html here using $.each
  //   
  //   return seat_html;
  // }
