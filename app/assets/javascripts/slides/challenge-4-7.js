jQuery(function($) {
  ...
  question("Create a custom event.. for the different tabs");
  ...
  var selectFlights = {
    ...
    init : function() {
      ...
      // $("#tabs ul li a").bind({'selectTab': selectFlights.changeTab});
      
      // got rid of the change tab method and moved contents into custom trigger
      $("#tabs ul li a").bind({
